...
typedef enum {NO_BACK = 0, BACK_OK = 1, BACK_ERROR = 2, BACK_TIMEOUT = 3, BACK_TRYOUT = 4, NEW_MESSAGE = 5} RETURN_STATUS;

typedef enum {NBIotRecvBuffEmpty = 0, NBIotRecvBuffNotEmpty = !NBIotRecvBuffEmpty} NBIotRecvBuffStatus;

//typedef enum {SLAVE = 0, MASTER = !SLAVE} BTModeStatus;
